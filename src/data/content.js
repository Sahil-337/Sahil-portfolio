...
export const profile = {
  ...
  tagline:
    'Data Scientist · Machine Learning & NLP · AI Systems Validation · Product Analytics',
}

export const hero = {
  eyebrow: 'Data Science · Analytics · AI/ML',
  headline: 'Turning data and AI systems into decisions teams can act on.',
  subheadline:
    'Data Scientist focused on Machine Learning, NLP, and AI systems validation — building Python and SQL workflows, BI dashboards, and product analytics that move from raw signal to clear, decision-ready insight.',
  badges: [
    'Python', 'SQL', 'XGBoost', 'NLP', 'Power BI', 'Tableau',
    'A/B Testing', 'KPI Dashboards', 'AI Systems Validation', 'Product Analytics',
  ],
  snapshot: {
